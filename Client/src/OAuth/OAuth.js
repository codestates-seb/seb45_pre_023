...
export const handleGithubLogin = () => {
  return window.location.assign(
    `https://github.com/login/oauth/authorize?client_id=482acf418bf96174b896&redirect_uri=http://sixman-front-s3.s3-website.ap-northeast-2.amazonaws.com`
  );
};

export const handleKakaoLogin = () => {
  return window.location.assign(
    `https://kauth.kakao.com/oauth/authorize?client_id=0c96492a94d3847f094fda7ec7a29407&redirect_uri=http://sixman-front-s3.s3-website.ap-northeast-2.amazonaws.com&response_type=code`
  );
};
