...
export default function HeaderBefore() {
    return (
        <header className="sticky top-0 flex flex-row justify-center items-center h-12 z-10 bg-white border-t-4 border-orange-400 border-b-1 border-b-gray-300">
          ...
          <Link to={RouteConst.Login} className="flex flex-row justify-center items-center w-42 h-11 hover:bg-gray-200 text-lg">
          ...
          <Search />
          <button className="w-14 h-8 mx-1 px-2 bg-sky-100 hover:bg-sky-200 rounded-md text-xs text-sky-600">Log in</button>
