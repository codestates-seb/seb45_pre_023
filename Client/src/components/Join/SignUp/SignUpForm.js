  ...
  return (
    <div className="flex flex-col items-center">
      <ul className="flex flex-col items-center mt-8">
        ...
        <li className="flex felx-row justify-center items-center w-80 h-10 my-1 bg-yellow-300 hover:bg-yellow-200 border border-solid border-gray rounded-md cursor-pointer">
          <img
